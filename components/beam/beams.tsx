...
import { AnimatedBeam } from "@/components/beam/animated-beam";
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[300px] w-full items-center justify-center  rounded-lg  bg-transarent mb-6"
      ref={containerRef}
    >
